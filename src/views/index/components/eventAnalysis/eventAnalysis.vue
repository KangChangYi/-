    ...
    <div class="son-app">
        ...
        <div class="chart-layout">
            ...
            <div class="date-picker-chart-type-layout">
                ...
                <div>
                    <el-radio-group
                        v-model="chartModifyType"
                        @change="clickChartModifyType($event)"
                        style="margin-right:20px"
                    >
                        <el-radio-button label="次数"></el-radio-button>
                        <el-radio-button label="人数"></el-radio-button>
                    </el-radio-group>
                    <el-radio-group
                        v-model="chartType"
                        @change="clickChartType($event)"
                    >
                        <el-radio-button label="线图"></el-radio-button>
                        <el-radio-button label="柱图"></el-radio-button>
